...
//Ham tao 2
	...
	public node(String nname, node parent, double value) {
		this.name = nname;
		this.sibling = null;
		this.children = null;
		this.parent =parent;
...
//phuong thuc copy node
	node CopyNode(node s){
		...
		if(s != null) 
		{
			...
			//t.semanticTraining = s.semanticTraining.clone();
			//t.semanticTesting = s.semanticTesting.clone();
			return t;
		}
		return null;
	}
