...
public class MainSAD extends Class_Random {
	public MainSAD() {}
	...
	String outDir = OUTDIR + "TRIAL100/SAD/";
...
//			f1.print(myPop.genotypeDist[0]+";");
			...
			// Complexity
			f1.print(complexity+";");
//			f1.print(myPop.bestBeforeFitness[0]+";"); //9
//			f1.print(myPop.avgDecreaseAllFitness[0]+";"); //10
//			f1.print(myPop.avgDecreaseFitness[0]+";"); //11
//			
//			f1.print(myPop.avgFitnessAllPopBefore[0]+";"); //12
//			f1.print(myPop.avgFitnessAllPopAfter[0]+";"); //13
//			f1.print(myPop.TheBestAvgInAllPopBefore[0]+";");//14
//			
//			
//			f1.print(myPop.avgFitnessNotPrune[0]+";");			//15
//			f1.print(myPop.avgFitnessBeforePrune[0]+";");//16			
//			f1.print(myPop.avgFitnessAfterPrune[0]+";"); //17
//			f1.print(myPop.TheBestAvgInNotPrune[0]+";"); //18
//			
//			
//			f1.print(myPop.TheBestFitnessNotPrune[0]+";"); //19
//			f1.print(myPop.TheBestFitnessPrune[0]+";"); //20
//			f1.println(myPop.TheBestInNotPrune[0]+";"); //21
...
//		f3.close();		
    ...
    {
		MainSAD a = new MainSAD();	
		System.out.printf("SAT- Random -AVG: "+ PROBLEM + "\n");
