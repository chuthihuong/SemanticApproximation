...
public class MainRDO_NewInstall extends Class_Random {
	public MainRDO_NewInstall() {}
...
//		f3.close();		
    ...
    {
		MainRDO_NewInstall a = new MainRDO_NewInstall();	
